...
- Provisions **two Multipass virtual machines**
- Prepares the VMs for Kubernetes prerequisites
...
- Automatically joins a worker node to the cluster
- Sets up **Flannel** for pod networking
- Configures **kubectl access** on the host machine
